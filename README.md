...
B. Brannen, Video Game Sales 2020 Dataset, Kaggle

E. Meeks & M. Heer, Stacked Graphs—Geometry & Aesthetics, IEEE TVCG

DASCA, Impactful Data Visualizations with D3.js

CodezUp, Interactive Visualizations with D3.js

Kong et al., Graphical Histories for Visualization, IEEE TVCG

Kandel et al., Research Directions in Data Wrangling, IEEE TVCG

D3 Graph Gallery – Pie Chart Examples

Mike Bostock, Stacked Bar Chart, Observable
